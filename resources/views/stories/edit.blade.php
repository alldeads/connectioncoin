        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('stories.update', ['story' => $story]) }}" enctype="multipart/form-data" novalidate>
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control form-control-lg" name="image[]" accept="image/x-png,image/gif,image/jpeg" multiple="multiple"  />
