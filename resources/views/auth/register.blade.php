    ...
    <div class="container-login100" style="background-color: #0085ad !important;">
        <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
            <div class="text-center">
                <img src="{{ asset('images/app_icon.png') }}" class="img-responsive w-100 mb-5">
            </div>
            <form class="login100-form validate-form" method="POST" action="{{ route('register') }}">
                ...
                {{-- <div class="wrap-input100 mb20 validate-input" data-validate="Privacy is required">
                    <input style="margin: 20px 0px 20px 0px;" class="input50" type="checkbox" name="privacy" required> I have read the <a href="/privacy">privacy policy</a>.
                </div> --}}

                <div class="wrap-input100 mb20 validate-input" data-validate="Terms is required">
                    <input style="margin: 20px 0px 20px 0px;" class="input50" type="checkbox" name="terms" required> I have read the <a href="/terms">privacy policy & terms of service</a>.
                </div>
